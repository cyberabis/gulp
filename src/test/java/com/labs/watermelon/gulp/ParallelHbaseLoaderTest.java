...
public class ParallelHbaseLoaderTest {
       ...
       public void test() {
               ...
               //ParallelHbaseLoader hl = new ParallelHbaseLoader(file, keyPattern, fileId, tableName, colFamily, colName);
               ParallelHbaseLoader hl = new ParallelHbaseLoader(file, keyPattern, keyStartIndex, keyEndIndex, noRegex, fileId, tableName, colFamily, colName);
               hl.load();
       }
}
